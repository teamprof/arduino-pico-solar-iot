...
wizfi360::RingBuffer WizFi360Drv::ringBuf(32);
...
void WizFi360Drv::reset()
{
	...
	// // set sleep mode to LightSleepMode (13mA)
	// sendCmd(F("AT+SLEEP=1"));

	// enable SNTP and set timezone to GMT+8 (Hong Kong)
	sendCmd(F("AT+CIPSNTPCFG=1,8,\"stdtime.gov.hk\",\"cn.ntp.org.cn\",\"us.pool.ntp.org\""));
	// sendCmd(F("AT+CIPSNTPCFG=1,8,\"stdtime.gov.hk\",\"0.hk.pool.ntp.org\",\"us.pool.ntp.org\""));
	// sendCmd(F("AT+CIPSNTPCFG=1,8,\"1.amazon.pool.ntp.org\",\"0.hk.pool.ntp.org\",\"us.pool.ntp.org\""));
	// sendCmd(F("AT+CIPSNTPCFG=1,8,\"cn.ntp.org.cn\",\"ntp.sjtu.edu.cn\",\"us.pool.ntp.org\""));
}
